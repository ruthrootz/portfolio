        ...
        <div class="section">
            ...
            <ul class="stack">
                <li class="li-icon">
                    ...
                    <div class="stack-text">Bootstrap</div>
                </li>
                <li class="li-icon">
                    <svg viewBox="0 0 128 128">
                ...
                <li class="li-icon">
                    ...
                    <div class="stack-text">TypeScript</div>
                </li>
                <li class="li-icon">
                    <svg viewBox="0 0 128 128">
                    ...
                    <div class="stack-text">Python</div>
                </li>
                <li class="li-icon">
                    <svg viewBox="0 0 128 128">
                    ...
                    <div class="stack-text">Django</div>
                </li>
                <li class="li-icon">
                    <svg viewBox="0 0 128 128">
        ...
        <div class="section">
            ...
            <ul>
                <li class="foggy-glass demo">
                    <a id="cubingtrainer" href="https://cubingtrainer.netlify.app/" target="_blank">cubing trainer
                        <div>
