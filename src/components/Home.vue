        ...
        <div class="section">
            <div class="projects">
                <ul>
                    <li class="demo">
                        <p>
                            I work at <a href="https://www.getrhyme.com/" target="_blank">Rhyme</a>, where we're on a mission to completely automate the prior authorization process in the U.S.
                        </p>
                    </li>
                    <li class="demo stack">
                        ...
                        <ul>
                            ...
                            <li class="li-icon" name="nvim">
                                <img src="@/assets/nvim.png" width="100%" />
                            </li>
                            <li class="li-icon" name="azure">
                                <img src="@/assets/azure.png" width="100%" />
                            </li>
                            <li class="li-icon" name="aws">
                                <img src="@/assets/aws.png" width="100%" />
                            </li>
                        </ul>
                    </li>
                </ul>
