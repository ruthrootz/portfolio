<template>
  <div class="center">
    <div class="about">
      ...
      <p class="bio__section-text">
        I'm a full-stack software engineer with experience in AWS, Azure, .NET
        Core, Node.js, and Vue.js. I'm a software engineer at
        <a href="https://www.getrhyme.com/" target="_blank">Rhyme</a>, on a
        mission to completely automate prior authorizations.
      </p>
      <ul>
        <li>
        ...
        <li>
          <a
            href="https://www.linkedin.com/in/ruth-oldja-3b1305141/"
            target="_blank"
          >
        ...
        <li>
          <a href="https://www.quantconnect.com/u/ruth-o" target="_blank">
            <img
              class="icon"
              src="@/assets/quantconnect.png"
              alt="quantconnect logo"
            />
            QuantConnect
          </a>
        </li>
