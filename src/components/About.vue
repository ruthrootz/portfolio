<template>
    <div class="center">
        <div class="about">
            ...
            <p class="bio__section-text">I work at <a href="https://www.getrhyme.com/" target="_blank">Rhyme</a> as a software engineer on a mission to speed up the prior authorization process! We're using AWS, .NET Core, TypeScript, Vue and Terraform.</p>
            <ul>
                <li>
